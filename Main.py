...
def checkHeading(target_heading, tolerance = 0.5):
    ...
    if abs(error) > tolerance:
        if error < 0 and rSpeed < 99:
            # Turn left
            print("Adjusting left")
            adjust_steering_angle(-0.025)  # Placeholder function for left adjustment
        elif error > 0 and lSpeed < 99:
            # Turn right
            print("Adjusting right")
            adjust_steering_angle(0.025)  # Placeholder function for right adjustment
